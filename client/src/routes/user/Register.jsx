...
/*
    Este componente se encarga de hacer el registro de un usuario, es decir, de realizar
    una petición POST. De la misma manera que en login, en el formulario de registro 
    comprobamos que las credenciales sean válidas y si son correctas, alertamos al usuario
...
export default function Register() {
    ...
    const postUser = async e => {
        ...
        if(user.dni.length > 0 && user.nombre.length > 0 && user.apellidos.length > 0 && user.edad > 0
            && credentials.email === "admin@admin.com" && credentials.password === "adminadmin" && user.telefono.length == 9 && user.direccion.length > 0){
            ...
            && user.email.length > 0 && user.password.length > 0 && user.telefono.length == 9 && user.direccion.length > 0){
